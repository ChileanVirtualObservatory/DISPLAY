...
\input{include/2_background}

\input{include/3_sota}

\input{include/4_data_origin}

\input{include/5_algorithm}

\input{include/6_results}

\input{include/7_conclusion}

\input{include/8_acknowledgments}
